...
//
  ...
  #define HOTEND0_PULLUP_RESISTOR_OHMS    4700 // Pullup resistor // kéo điện trở lên
  #define HOTEND0_RESISTANCE_25C_OHMS   100000 // Resistance at 25C // khả nằng chống chịu
  #define HOTEND0_BETA                    3950 // Beta value
  #define HOTEND0_SH_C_COEFF                 0 // Steinhart-Hart C coefficient // hé số 
#endif
...
#define HOMING_BUMP_MM      { 5, 5, 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump // ĐIỀU CHỈNH ĐỘ NHẠY KHI HOMING
